...
Political alignment and self-identification as an environmentalist are not independent (there is a significant association between political alignment and response to the env_id question of the survey). 
