...
#### Table 1. Survey responses to "ev_id" or "I consider myself an environmentalist".
...
Political alignment and response to env_id ("I consider myself an environmentalist") are not independent (there is a significant association between political alignment and response to env_id of the survey). 

$\chi$^2^(`r q1_tidy$parameter`) = `r round(q1_tidy$statistic,2)`, *p* = `r round(q1_tidy$p.value,3)`
